        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2 sm:gap-4 h-full">
          <div className="col-span-2 bg-gray-800 rounded-lg relative overflow-hidden flex items-center justify-center">
            <div className="text-center">
              <GraduationCap className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-4 text-blue-400" />
              <h3 className="text-lg sm:text-xl font-semibold">{user?.name || 'Instructor'}</h3>
              <p className="text-gray-300">Instructor</p>
            </div>
            <div className="absolute bottom-2 left-2 sm:bottom-4 sm:left-4 bg-black/50 px-2 py-1 rounded text-xs sm:text-sm">{user?.name || 'Instructor'}</div>
          </div>
