...
const QuizChecker = () => {
    ...
    const handleSearch = async () => {
        ...
        setLoading(true);
        try {
            const res = await axios.get(`${API}/api/student-quizzes/class/submissions/all`, {
                params: {
                    year: filter.year,
    ...
    const handleSaveMarks = async (submissionId) => {
        ...
        try {
            const res = await axios.put(
                `${API}/api/student-quizzes/${submissionId}/marks`,
                {
    ...
    return (
        <div className="p-6 text-white min-h-screen">
            <h1 className="text-3xl font-bold mb-6 text-white">Check Quizzes</h1>
                            ...
                            <tbody className="divide-y divide-gray-800">
                                {submissions.map((submission) => (
                                    <tr key={submission._id} className="hover:bg-gray-700/30 transition-colors">
                                        ...
                                        <td className="px-6 py-4">{submission.quizTitle}</td>
